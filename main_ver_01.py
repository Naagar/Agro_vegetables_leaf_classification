...
import wandb
# 2ab92307128f1ed1aa03d4688a9cf19b1f1c0b93
# wandb.init(project="test-project", entity="agro_startup")
# wandb.login('2ab92307128f1ed1aa03d4688a9cf19b1f1c0b93')
...
writer = SummaryWriter('runs/mobilenet_three_class/')
...
data_dir = 'dataset/' # data1 #data_plus_fake
